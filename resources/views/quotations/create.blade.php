...
@section('content')
    ...
    <div class="row">
        <div class="col-xl-7">
            ...
            <div class="card">
                <div class="card-body">
                    <form method="POST" action="{{ route('quotations.store', $customer->id) }}">
                        @csrf
                        <!-- Nav tabs -->
                        ...
                        <div class="tab-content pt-3">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="names" id="names" class="form-control{{ $errors->has('active') ? ' is-invalid' : '' }}" maxlength="50" placeholder="Máximo 50 caracteres" value="{{ $customer->names }}" data-validation="required" data-sanitize="trim capitalize">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="surnames" id="surnames" class="form-control{{ $errors->has('active') ? ' is-invalid' : '' }}" maxlength="50" placeholder="Máximo 50 caracteres" value="{{ $customer->surnames }}" data-validation="required" data-sanitize="trim capitalize">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select name="identification_type" id="identification_type" class="custom-select{{ $errors->has('identification_type') ? ' is-invalid' : '' }}" data-validation="required">
                                                ...
                                                <option value="{{ App\Customer::CEDULA }}" data-url="{{ route('validations.validar_cedula') }}" data-length="10"{{ $customer->identification_type == App\Customer::CEDULA ? ' selected' : '' }}>Cédula</option>
                                                <option value="{{ App\Customer::RUC }}" data-url="{{ route('validations.validar_ruc') }}" data-length="10"{{ $customer->identification_type == App\Customer::RUC ? ' selected' : '' }}>RUC</option>
                                                <option value="{{ App\Customer::PASAPORTE }}{{ $customer->identification_type == App\Customer::PASAPORTE ? ' selected' : '' }}">Pasaporte</option>
                                            </select>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="identification" id="identification" class="form-control{{ $errors->has('identification') ? ' is-invalid' : '' }}" value="{{ $customer->identification }}" maxlength="50" placeholder="Máximo 20 caracteres" data-validation="required" data-validation-url="" data-sanitize="trim upper">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="province_id" id="province_id" class="custom-select{{ $errors->has('province_id') ? ' is-invalid' : '' }}" data-validation="required" data-url="{{ route('cities.index') }}">
                                                ...
                                                @foreach ($provinces as $id => $name)
                                                    <option value="{{ $id }}" {{ $customer->city->province_id == $id ? 'selected' : '' }}>{{ $name }}</option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="city_id" id="city_id" class="custom-select{{ $errors->has('city_id') ? ' is-invalid' : '' }}" data-validation="required">
                                                @foreach ($cities as $id => $name)
                                                    <option value="{{ $id }}" {{ $customer->city_id == $id ? 'selected' : '' }}>{{ $name }}</option>
                                                @endforeach
                                            </select>
                                ...
                                <div class="row">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="contact_method_id" id="contact_method_id" class="custom-select{{ $errors->has('contact_method_id') ? ' is-invalid' : '' }}" data-validation="required">
                                                ...
                                                @foreach ($contact_methods as $id => $name)
                                                    <option value="{{ $id }}" {{ $customer->contact_method_id == $id ? 'selected' : '' }}>{{ $name }}</option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="email" id="email" class="form-control{{ $errors->has('active') ? ' is-invalid' : '' }}" maxlength="150" placeholder="Máximo 150 caracteres" value="{{ $customer->email }}" data-validation="required email" data-sanitize="trim lower">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md">
                                        <div class="form-group">
                                            ...
                                            <select name="product_use" id="product_use" class="custom-select{{ $errors->has('product_use') ? ' is-invalid' : '' }}" data-validation="">
                                                <option value="">- Seleccione un item -</option>
                            ...
                            <div class="tab-pane" id="observations-tab" role="tabpanel">
                                <div class="form-group">
                                    <label for="comment">Comentarios del referido sobre el producto</label>
