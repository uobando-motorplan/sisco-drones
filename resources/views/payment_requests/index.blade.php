            ...
            <div class="page-title-box d-flex align-items-center justify-content-between">
                ...
                <div class="page-title-right d-none d-sm-block">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active"><a href="javascript: void(0);"></a>Listar</li>
                    </ol>
                </div>
            </div>
        </div>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="card-title font-16 mt-1 mb-0" id="destroyModalLabel">Anular solicitud de pago</h4>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    ¿Está seguro de anular la solicitud de pago <strong></strong>?
                </div>
...
@push('js')
    ...
    var dtable = $('#datatable').DataTable({
        ...
        processing: true,
        serverSide: true,
        ajax: '{{ route('payment_requests.datatables') }}',
        language: {
